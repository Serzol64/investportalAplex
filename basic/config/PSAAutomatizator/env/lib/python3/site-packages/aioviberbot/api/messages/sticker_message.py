...
class StickerMessage(TypedMessage):
    def __init__(self, tracking_data=None, keyboard=None,
                 sticker_id=None, min_api_version=None):
        super(
            StickerMessage,
            self).__init__(
            MessageType.STICKER,
    ...
    def __str__(self):
        return 'StickerMessage [{0}, sticker_id={1}]'.format(
            super(StickerMessage, self).__str__(), self._sticker_id)
