...
class UrlMappingMatchInfo(BaseDict, AbstractMatchInfo):
    ...
    @contextmanager
    def set_current_app(
            self, app: "Application") -> Generator[None, None, None]:
        ...
        for route_obj in self._routes:
            ...
            if route_method == request.method or route_method == hdrs.METH_ANY:
                return (UrlMappingMatchInfo(
                    match_dict, route_obj), allowed_methods)
        else:
            return None, allowed_methods
...
class StaticResource(PrefixResource):
    ...
    def __init__(
        ...
        *,
        ...
        try:
            ...
            raise ValueError(
                f"No directory exists at '{directory}'") from error
    ...
    async def resolve(self, request: Request) -> _Resolve:
        ...
        return (UrlMappingMatchInfo(
            match_dict, self._routes[method]), allowed_methods)
...
class View(AbstractView):
    ...
    def _raise_allowed_methods(self) -> None:
        allowed_methods = {
            m for m in hdrs.METH_ALL if hasattr(
                self, m.lower())}
...
class UrlDispatcher(AbstractRouter, Mapping[str, AbstractResource]):
    ...
    def add_head(self, path: str, handler: Handler,
                 **kwargs: Any) -> AbstractRoute:
        """Shortcut for add_route with method HEAD."""
        return self.add_route(hdrs.METH_HEAD, path, handler, **kwargs)

    def add_options(self, path: str, handler: Handler,
                    **kwargs: Any) -> AbstractRoute:
    ...
    def add_post(self, path: str, handler: Handler,
                 **kwargs: Any) -> AbstractRoute:
        """Shortcut for add_route with method POST."""
        return self.add_route(hdrs.METH_POST, path, handler, **kwargs)

    def add_put(self, path: str, handler: Handler,
                **kwargs: Any) -> AbstractRoute:
        """Shortcut for add_route with method PUT."""
        return self.add_route(hdrs.METH_PUT, path, handler, **kwargs)

    def add_patch(self, path: str, handler: Handler,
                  **kwargs: Any) -> AbstractRoute:
        """Shortcut for add_route with method PATCH."""
        return self.add_route(hdrs.METH_PATCH, path, handler, **kwargs)

    def add_delete(self, path: str, handler: Handler,
                   **kwargs: Any) -> AbstractRoute:
    ...
    def add_routes(
            self, routes: Iterable[AbstractRouteDef]) -> List[AbstractRoute]:
