...
class TCPConnector(BaseConnector):
    ...
    def _get_fingerprint(
            self, req: "ClientRequest") -> Optional["Fingerprint"]:
        ret = req.ssl
    ...
    async def _create_direct_connection(
        ...
        *,
        ...
        try:
            ...
            def drop_exception(
                    fut: "asyncio.Future[List[Dict[str, Any]]]") -> None:
            ...
            try:
                ...
                try:
                    ...
                    if not runtime_has_start_tls:
                        ...
                        # Duplicate the socket, so now we can close proxy
                        # transport
                        rawsock = rawsock.dup()
                except BaseException:
