...
class _DocumentNav:
    ...
    def is_special_string(obj: 'bs4.PageElement') -> bool:
        """Is special string."""
        return isinstance(obj, (bs4.Comment, bs4.Declaration,
                          bs4.CData, bs4.ProcessingInstruction, bs4.Doctype))
    ...
    def get_contents(self, el: 'bs4.Tag',
    ...
    @classmethod
    def get_previous(cls, el: 'bs4.Tag',
    ...
    @staticmethod
    def split_namespace(
            el: 'bs4.Tag', attr_name: str) -> Tuple[Optional[str], Optional[str]]:
    ...
    def get_text(self, el: 'bs4.Tag', no_iframe: bool = False) -> str:
        ...
        return ''.join(
            [node for node in self.get_descendants(
                el, tags=False, no_iframe=no_iframe) if self.is_content_string(node)]
        )

    def get_own_text(self, el: 'bs4.Tag',
...
class CSSMatch(_DocumentNav):
    ...
    def match_past_relations(self, el: 'bs4.Tag',
    ...
    def match_future_child(self, parent: 'bs4.Tag',
                           relation: ct.SelectorList, recursive: bool = False) -> bool:
        """Match future child."""
    ...
    def match_future_relations(self, el: 'bs4.Tag',
                               relation: ct.SelectorList) -> bool:
    ...
    def match_relations(self, el: 'bs4.Tag',
                        relation: ct.SelectorList) -> bool:
        """Match relationship to other elements."""

        found = False

        if isinstance(relation[0],
            ...
            for k, v in self.iter_attributes(parent):
                ...
                if (
                    ...
                    (
                        ...
                        (util.lower(
                            attr) if not self.is_xml and attr is not None else attr) == 'lang'
                    )
                ):
                    found_lang = v
                    break
    ...
    def match_dir(self, el: 'bs4.Tag', directionality: int) -> bool:
        ...
        if ((is_input and itype in ('text', 'search', 'tel', 'url', 'email'))
            ...
            if value:
                ...
                return ct.SEL_DIR_LTR == directionality
            return self.match_dir(self.get_parent(
                el, no_iframe=True), directionality)
    ...
    def match_selectors(self, el: 'bs4.Tag',
...
class SoupSieve(ct.Immutable):
    ...
    def match(self, tag: 'bs4.Tag') -> bool:
        ...
        return CSSMatch(self.selectors, tag, self.namespaces,
    ...
    def filter(self, iterable: Iterable['bs4.Tag']) -> List['bs4.Tag']:  # noqa A001
        ...
        if CSSMatch.is_tag(iterable):
            return CSSMatch(self.selectors, iterable,
                            self.namespaces, self.flags).filter()
        else:
    ...
    def iselect(self, tag: 'bs4.Tag', limit: int = 0) -> Iterator['bs4.Tag']:
        ...
        for el in CSSMatch(self.selectors, tag, self.namespaces,
