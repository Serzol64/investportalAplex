...
class Immutable:
    ...
    def __eq__(self, other: Any) -> bool:
        ...
        return (
            ...
            all([getattr(other, key) == getattr(self, key)
                for key in self.__slots__ if key != '_hash'])
        )
    ...
    def __ne__(self, other: Any) -> bool:
        ...
        return (
            ...
            any([getattr(other, key) != getattr(self, key)
                for key in self.__slots__ if key != '_hash'])
        )
...
class SelectorNth(Immutable):
    ...
    def __init__(self, a: int, n: bool, b: int, of_type: bool,
                 last: bool, selectors: 'SelectorList') -> None:
        """Initialize."""
...
class SelectorList(Immutable):
    ...
    def __init__(
        self,
        selectors: Optional[Iterable[Union['Selector',
                                           'SelectorNull']]] = None,
        is_not: bool = False,
        is_html: bool = False
    ) -> None:
