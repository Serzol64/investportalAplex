...
class _Selector:
    ...
    def _freeze_relations(
            self, relations: List['_Selector']) -> ct.SelectorList:
        """Freeze relation."""
...
class CSSParser:
    ...
    css_tokens = (
        ...
        SpecialPseudoPattern(
            (
                ...
                ("pseudo_nth_child", (':nth-child', ':nth-last-child'),
                 PAT_PSEUDO_NTH_CHILD, SelectorPattern),
                ("pseudo_nth_type", (':nth-of-type', ':nth-last-of-type'),
                 PAT_PSEUDO_NTH_TYPE, SelectorPattern),
    ...
    def parse_attribute_selector(
            self, sel: _Selector, m: Match[str], has_selector: bool) -> bool:
    ...
    def parse_tag_pattern(self, sel: _Selector,
                          m: Match[str], has_selector: bool) -> bool:
    ...
    def parse_class_id(self, sel: _Selector,
                       m: Match[str], has_selector: bool) -> bool:
    ...
    def parse_pseudo_contains(self, sel: _Selector,
                              m: Match[str], has_selector: bool) -> bool:
        """Parse contains."""
    ...
    def parse_pseudo_lang(self, sel: _Selector,
                          m: Match[str], has_selector: bool) -> bool:
    ...
    def parse_pseudo_dir(self, sel: _Selector,
                         m: Match[str], has_selector: bool) -> bool:
    ...
    def process_selectors(self, index: int = 0,
