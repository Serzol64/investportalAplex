...
def full(shape, fill_value, dtype=None, order='C', *, like=None):
    ...
    if like is not None:
        return _full_with_like(
            shape, fill_value, dtype=dtype, order=order, like=like)
...
def _full_like_dispatcher(a, fill_value, dtype=None,
                          order=None, subok=None, shape=None):
    return (a,)
