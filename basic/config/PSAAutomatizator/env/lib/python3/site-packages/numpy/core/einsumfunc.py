...
def _greedy_path(input_sets, output_set, idx_dict, memory_limit):
    ...
    for iteration in range(len(input_sets) - 1):
        ...
        # Iterate over all pairs on first step, only previously found pairs on
        # subsequent steps
        ...
        # If we do not have a inner contraction, rescan pairs including outer
        # products
        if len(known_contractions) == 0:
            ...
            # If we still did not find any remaining contractions, default back
            # to einsum like behavior
            if len(known_contractions) == 0:
        ...
        # Now propagate as many unused contractions as possible to next
        # iteration
...
def einsum_path(*operands, optimize='greedy', einsum_call=False):
    ...
    *operands : list of array_like
    ...
    # Compute the path
    if (path_type is False) or (len(input_list)
                                in [1, 2]) or (indices == output_set):
