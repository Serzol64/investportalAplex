...
def datetime_ceil(dateval):
    ...
    if dateval.microsecond > 0:
        return dateval + \
            timedelta(seconds=1, microseconds=-dateval.microsecond)
    return dateval
...
def get_callable_name(func):
    ...
    raise TypeError(
        'Unable to determine a name for %r -- maybe it is not a callable?' %
        func)
...
def ref_to_obj(ref):
    ...
    try:
        ...
        raise LookupError(
            'Error resolving reference %s: could not import module' %
            ref)
    ...
    try:
        ...
        raise LookupError(
            'Error resolving reference %s: error looking up object' %
            ref)
...
def check_callable_args(func, args, kwargs):
    ...
    # Check that the callable can accept the given number of positional
    # arguments
