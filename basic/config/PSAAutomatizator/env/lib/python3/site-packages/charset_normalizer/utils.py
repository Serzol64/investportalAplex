...
def any_specified_encoding(
        sequence: bytes, search_zone: int = 4096) -> Optional[str]:
    """
...
def is_multi_byte_encoding(name: str) -> bool:
    ...
    return name in {
        ...
        importlib.import_module("encodings.{}".format(
            name)).IncrementalDecoder,  # type: ignore
...
def cp_similarity(iana_name_a: str, iana_name_b: str) -> float:
    ...
    decoder_a = importlib.import_module("encodings.{}".format(
        iana_name_a)).IncrementalDecoder  # type: ignore
    decoder_b = importlib.import_module("encodings.{}".format(
        iana_name_b)).IncrementalDecoder  # type: ignore
