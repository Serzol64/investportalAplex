...
def create_and_load_types_sqlite3(
        conn: sqlite3.Connection, types_data: list[dict]):
    cur = conn.cursor()
...
class PandasSQLTest:
    ...
    def _to_sql_with_sql_engine(
            self, test_frame1, engine="auto", **engine_kwargs):
...
@pytest.mark.skipif(not SQLALCHEMY_INSTALLED,
...
class TestSQLApi(SQLAlchemyMixIn, _TestSQLApi):
    ...
    def test_read_table_index_col(self, test_frame1):
        ...
        result = sql.read_sql_table(
            "test_frame", self.conn, index_col=[
                "A", "B"])
