    ...
    def _format_strings(self) -> list[str]:
        ...
        if formatter is None:
            ...
            formatter = values._formatter(
                boxed=True)  # type: ignore[union-attr]
...
def get_format_timedelta64(
    ...
    both = np.logical_and(
        consider_values,
        not_midnight)  # type: ignore[arg-type]
...
def _trim_zeros_complex(str_complexes: np.ndarray,
...
class EngFormatter:
    ...
    def __init__(self, accuracy: int | None = None,
