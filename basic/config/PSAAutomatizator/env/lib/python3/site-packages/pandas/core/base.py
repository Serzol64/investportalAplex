...
class PandasObject(DirNamesMixin):
    ...
    # results from calls to methods decorated with cache_readonly get added to
    # _cache
    _cache: dict[str, Any]
...
class IndexOpsMixin(OpsMixin):
    ...
    def _map_values(self, mapper, na_action=None):
        ...
        if is_dict_like(mapper):
            if isinstance(mapper, dict) and hasattr(mapper, "__missing__"):
                ...
                def mapper(x): return dict_with_default[x]
            else:
        ...
        if is_extension_array_dtype(
                self.dtype) and hasattr(self._values, "map"):
    ...
    def unique(self):
        ...
        if not isinstance(values, np.ndarray):
            ...
            if self.dtype.kind in ["m", "M"] and isinstance(self, ABCSeries):
                # GH#31182 Series._values returns EA, unpack for
                # backward-compat
    ...
    # pandas.core.resample.TimeGrouper._get_period_bins picks the correct
    # result
    ...
    def searchsorted(
        ...
        values = self._values
        if not isinstance(values, np.ndarray):
            # Going through EA.searchsorted directly improves performance
            # GH#38083
