...
class TestTimedelta64ArrayLikeComparisons:
    ...
    def test_compare_timedelta64_zerodim(self, box_with_array):
        ...
        box = box_with_array
        xbox = (
            box_with_array if box_with_array not in [
                pd.Index, pd.array] else np.ndarray
        )
...
class TestTimedeltaArraylikeAddSubOps:
    ...
    def test_td64arr_with_offset_series(self, names, box_with_array):
        ...
        expected_add = Series([tdi[n] + other[n]
                              for n in range(len(tdi))], name=exname)
        obj = tm.box_expected(tdi, box)
        ...
        expected_sub = Series([tdi[n] - other[n]
                              for n in range(len(tdi))], name=exname)
