...
class TestPlotBase:
    ...
    def _check_axes_shape(self, axes, axes_num=None,
    ...
    def get_x_axis(self, ax):
        return ax._shared_axes["x"] if self.compat.mpl_ge_3_5_0(
        ) else ax._shared_x_axes

    def get_y_axis(self, ax):
        return ax._shared_axes["y"] if self.compat.mpl_ge_3_5_0(
        ) else ax._shared_y_axes


def _check_plot_works(f, filterwarnings="always",
                      default_axes=False, **kwargs):
    """
