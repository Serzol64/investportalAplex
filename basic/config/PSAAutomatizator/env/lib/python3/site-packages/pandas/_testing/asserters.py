...
def assert_index_equal(
    ...
    def _check_types(left, right, obj="Index") -> None:
        ...
        if is_categorical_dtype(
                left.dtype) and is_categorical_dtype(right.dtype):
    ...
    if check_categorical:
        if is_categorical_dtype(
                left.dtype) or is_categorical_dtype(right.dtype):
...
def assert_series_equal(
    ...
    *,
    ...
    if check_exact and is_numeric_dtype(
            left.dtype) and is_numeric_dtype(right.dtype):
...
def is_extension_array_dtype_and_needs_i8_conversion(
    ...
    """
    return is_extension_array_dtype(
        left_dtype) and needs_i8_conversion(right_dtype)
