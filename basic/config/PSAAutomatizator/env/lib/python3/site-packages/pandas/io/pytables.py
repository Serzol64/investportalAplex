...
class IndexCol:
    ...
    def convert(self, values: np.ndarray, nan_rep, encoding: str, errors: str):
        ...
        if is_datetime64_dtype(
                values.dtype) or is_datetime64tz_dtype(values.dtype):
...
class Table(Fixed):
    ...
    def create_index(self, columns=None, optlevel=None,
                     kind: str | None = None):
        """
...
def _reindex_axis(obj: DataFrame, axis: int, labels: Index,
