...
class DatetimeLikeArrayMixin(OpsMixin, NDArrayBackedExtensionArray):
    ...
    def __init__(self, data, dtype: Dtype |
                 None = None, freq=None, copy=False):
    ...
    def _validate_searchsorted_value(self, value):
        if not is_list_like(value):
            return self._validate_scalar(
                value, allow_listlike=True, setitem=False)
        else:
    ...
    def __add__(self, other):
        ...
        if isinstance(result, np.ndarray) and is_timedelta64_dtype(
                result.dtype):
            from pandas.core.arrays import TimedeltaArray
    ...
    def __rsub__(self, other):
        ...
        if is_datetime64_any_dtype(
                other_dtype) and is_timedelta64_dtype(self.dtype):
    ...
    def median(self, *, axis: int | None = None,
