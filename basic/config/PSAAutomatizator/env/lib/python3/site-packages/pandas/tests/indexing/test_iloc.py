...
class TestiLocBaseIndependent:
    ...
    def test_iloc_setitem_fullcol_categorical(
        ...
        # TODO with mixed dataframe ("split" path), we always overwrite the
        # column
    ...
    def test_iloc_setitem_ea_inplace(
            self, frame_or_series, box, using_array_manager):
    ...
    def test_identity_slice_returns_new_object(
        ...
        # Setting using .loc[:, "a"] sets inplace so alters both sliced and
        # orig
...
class TestILocErrors:
    ...
    # TODO(ArrayManager) "split" path doesn't properly implement DataFrame
    # indexer
    @td.skip_array_manager_not_yet_implemented
