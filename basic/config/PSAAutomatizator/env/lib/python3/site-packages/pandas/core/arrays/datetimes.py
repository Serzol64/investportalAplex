...
class DatetimeArray(dtl.TimelikeOps, dtl.DatelikeOps):
    ...
    _datetimelike_ops: list[str] = _field_ops + \
        _object_ops + _bool_ops + _other_ops
    ...
    def __init__(self, values, dtype=DT64NS_DTYPE,
                 freq=None, copy: bool = False):
    ...
    def _box_func(self, x) -> Timestamp | NaTType:
        ...
        if ts is not NaT:  # type: ignore[comparison-overlap]
            # GH#41586
            # do this instead of passing to the constructor to avoid
            # FutureWarning
...
default 'raise'
    ...
    def to_perioddelta(self, freq) -> TimedeltaArray:
        ...
        warnings.warn(
            ...
            FutureWarning,
            # stacklevel chosen to be correct for when called from
            # DatetimeIndex
            stacklevel=find_stack_level(),
        )
...
def sequence_to_datetimes(
        data, require_iso8601: bool = False) -> DatetimeArray:
    """
...
def _maybe_localize_point(ts, is_none, is_not_none,
                          freq, tz, ambiguous, nonexistent):
    """
