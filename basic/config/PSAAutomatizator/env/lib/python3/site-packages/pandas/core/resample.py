...
class Resampler(BaseGroupBy, PandasObject):
    ...
    def transform(self, arg, *args, **kwargs):
        ...
        """
        return self._selected_obj.groupby(
            self.groupby).transform(arg, *args, **kwargs)
...
class TimeGrouper(Grouper):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # Handle deprecated arguments since v1.1.0 of `base` and `loffset` (GH
        # #31809)
        if base is not None and offset is not None:
            raise ValueError(
                "'offset' and 'base' cannot be present at the same time")
