...
class BaseWindow(SelectionMixin):
    ...
    def __init__(
        ...
        *,
        ...
        self.center = center
        # TODO(2.0): Change this back to self.win_type once deprecation is
        # enforced
    ...
    def _numba_apply(
        ...
        *func_args,
        ...
        if obj.ndim == 1:
            ...
            out = obj._constructor(
                result, index=obj.index, columns=obj.columns)
            return self._resolve_output(out, obj)
...
class RollingAndExpandingMixin(BaseWindow):
        ...
        if maybe_use_numba(engine):
            if self.method == "table":
                ...
                return self._numba_apply(
                    sliding_sum, "rolling_sum", engine_kwargs)
        window_func = window_aggregations.roll_sum
        ...
        **kwargs,
        ...
        if maybe_use_numba(engine):
            if self.method == "table":
                ...
                return self._numba_apply(
                    sliding_mean, "rolling_mean", engine_kwargs)
        ...
        **kwargs,
        ...
        if maybe_use_numba(engine):
            if self.method == "table":
                ...
                return zsqrt(
                    self._numba_apply(
                        sliding_var, "rolling_std", engine_kwargs, ddof)
                )
    ...
    def cov(
        ...
        **kwargs,
        ...
        return self._apply_pairwise(
            self._selected_obj, other, pairwise, cov_func)
    ...
    def corr(
        ...
        **kwargs,
        ...
        return self._apply_pairwise(
            self._selected_obj, other, pairwise, corr_func)
