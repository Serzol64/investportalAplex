...
class BaseArrayManager(DataManager):
    ...
    def apply_with_block(self: T, f, align_keys=None,
                         swap_axis=True, **kwargs) -> T:
        ...
        for i, arr in enumerate(self.arrays):
            ...
            # attribute "tz"
            if hasattr(
                    arr, "tz") and arr.tz is None:  # type: ignore[union-attr]
                # DatetimeArray needs to be converted to ndarray for
                # DatetimeLikeBlock
                ...
                # TimedeltaArray needs to be converted to ndarray for
                # TimedeltaBlock
