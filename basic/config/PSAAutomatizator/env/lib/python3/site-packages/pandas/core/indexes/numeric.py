...
class NumericIndex(Index):
    ...
    def __new__(cls, data=None, dtype: Dtype |
                None = None, copy=False, name=None):
    ...
    def _ensure_array(cls, data, dtype, copy: bool):
        ...
        if copy or not is_dtype_equal(data.dtype, dtype):
            ...
            # See
            # https://github.com/pandas-dev/pandas/pull/41153#discussion_r676206222
            try:
    ...
    def _ensure_dtype(cls, dtype: Dtype | None) -> np.dtype | None:
        ...
        if cls._is_backward_compat_public_numeric_index:
            ...
            # dtype for Int64Index, UInt64Index etc. Needed for backwards
            # compat.
            return cls._default_dtype
    ...
    def astype(self, dtype, copy: bool = True):
        ...
        if is_float_dtype(self.dtype):
            ...
            # When Int64Index etc. are removed from the code base, removed this
            # also.
    ...
    def _is_comparable_dtype(self, dtype: DtypeObj) -> bool:
        # If we ever have BoolIndex or ComplexIndex, this may need to be
        # tightened
        return is_numeric_dtype(dtype)

    @classmethod
    def _assert_safe_casting(cls, data: np.ndarray,
                             subarr: np.ndarray) -> None:
        """
