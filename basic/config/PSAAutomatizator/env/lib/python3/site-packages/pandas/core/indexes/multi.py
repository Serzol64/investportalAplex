...
class MultiIndex(Index):
    ...
    def _verify_integrity(self, codes: list | None = None,
    ...
    def from_arrays(cls, arrays, sortorder=None,
                    names=lib.no_default) -> MultiIndex:
        """
    ...
    @classmethod
    def from_frame(cls, df: DataFrame, sortorder=None,
    ...
    @deprecate_nonkeyword_arguments(version=None,
                                    allowed_args=["self", "codes"])
    def set_codes(self, codes, level=None, inplace=None,
                  verify_integrity: bool = True):
        """
    ...
    def set_names(self, names, level=None,
                  inplace: bool = False) -> MultiIndex | None:
