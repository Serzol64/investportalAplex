...
class MPLPlot:
    ...
    def result(self):
        ...
        if self.subplots:
            ...
            all_sec = (
                is_list_like(
                    self.secondary_y) and len(
                    self.secondary_y) == self.nseries
            )
    ...
    def _plot(cls, ax: Axes, x, y, style=None,
              is_errorbar: bool = False, **kwds):
        mask = isna(y)
        if mask.any():
            y = np.ma.array(y)
...
class ScatterPlot(PlanePlot):
    ...
    def _make_plot(self):
        ...
        cb = self.kwds.pop(
            "colorbar",
            is_numeric_dtype(c_values) and plot_colorbar)
...
class BarPlot(MPLPlot):
    ...
    def _decorate_ticks(self, ax: Axes, name, ticklabels,
                        start_edge, end_edge):
