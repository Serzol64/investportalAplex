...
class TestSetOps:
    ...
    def test_corner_union(self, index_flat_unique,
                          fname, sname, expected_name):
        # GH#9943, GH#9862
    ...
    def test_union_unequal(self, index_flat_unique,
                           fname, sname, expected_name):
        index = index_flat_unique
    ...
    def test_corner_intersect(self, index_flat_unique,
                              fname, sname, expected_name):
        # GH#35847
    ...
    def test_intersect_unequal(
            self, index_flat_unique, fname, sname, expected_name):
        index = index_flat_unique
