...
class NDFrame(PandasObject, indexing.IndexingMixin):
    ...
    def _set_axis_nocheck(self, labels, axis: Axis, inplace: bool_t):
        # NDFrame.rename with inplace=False calls set_axis(inplace=True) on a
        # copy.
        if inplace:
    ...
    @rewrite_axis_style_signature("mapper",
    ...
    def _get_label_or_level_values(
            self, key: str, axis: int = 0) -> np.ndarray:
        """
    ...
    def __array_wrap__(
        ...
        return self._constructor(
            res, **d).__finalize__(self, method="__array_wrap__")
    ...
    def _repr_data_resource_(self):
        ...
        if config.get_option("display.html.table_schema"):
            ...
            return json.loads(
                as_json, object_pairs_hook=collections.OrderedDict)
    ...
    def _get_numeric_data(self):
        return self._constructor(
            self._mgr.get_numeric_data()).__finalize__(self)
    ...
    def interpolate(
        ...
        **kwargs,
        ...
        if limit_direction is None:
            ...
            if method in ("backfill",
                          "bfill") and limit_direction != "backward":
                raise ValueError(
    ...
    @final
    def at_time(self: NDFrameT, time, asof: bool_t = False,
                axis=None) -> NDFrameT:
        """
    ...
    def between_time(
        ...
        # have been passed
            ...
            left = True if isinstance(
                include_start, lib.NoDefault) else include_start
            right = True if isinstance(
                include_end, lib.NoDefault) else include_end
        ...
        if is_series:
            ...
            if axis in [0, 1]:
                ...
                if lidx is not None:
                    ...
                    fdata = fdata.reindex_indexer(
                        join_index, lidx, axis=bm_axis)
    ...
    def _where(
        ...
        if isinstance(cond, NDFrame):
            cond, _ = cond.align(
                self, join="right", broadcast_axis=1, copy=False)
        else:
    ...
    def shift(
        ...
        if freq is None:
            ...
            return self._constructor(
                new_data).__finalize__(self, method="shift")
    ...
    @final
    def tshift(self: NDFrameT, periods: int = 1,
               freq=None, axis: Axis = 0) -> NDFrameT:
        """
    ...
    def _add_numeric_operations(cls):
        ...
        def any(self, axis=0, bool_only=None,
        ...
        def all(self, axis=0, bool_only=None,
                skipna=True, level=None, **kwargs):
        ...
        def sem(
            ...
            **kwargs,
            ...
            return NDFrame.sem(self, axis, skipna, level,
        ...
        def var(
            ...
            **kwargs,
            ...
            return NDFrame.var(self, axis, skipna, level,
                               ddof, numeric_only, **kwargs)
        ...
        def std(
            ...
            **kwargs,
            ...
            return NDFrame.std(self, axis, skipna, level,
                               ddof, numeric_only, **kwargs)
        ...
        def mean(
            ...
            **kwargs,
            ...
            return NDFrame.mean(self, axis, skipna, level,
                                numeric_only, **kwargs)
        ...
        def skew(
            ...
            **kwargs,
            ...
            return NDFrame.skew(self, axis, skipna, level,
                                numeric_only, **kwargs)
        ...
        def kurt(
            ...
            **kwargs,
            ...
            return NDFrame.kurt(self, axis, skipna, level,
                                numeric_only, **kwargs)
        ...
        def median(
            ...
            **kwargs,
            ...
            return NDFrame.median(self, axis, skipna,
        ...
        def max(
            ...
            **kwargs,
            ...
            return NDFrame.max(self, axis, skipna, level,
                               numeric_only, **kwargs)
        ...
        def min(
            ...
            **kwargs,
            ...
            return NDFrame.min(self, axis, skipna, level,
                               numeric_only, **kwargs)
    ...
    def __ior__(self, other):
        # error: Unsupported left operand type for | ("Type[NDFrame]")
        return self._inplace_method(other, type(
            self).__or__)  # type: ignore[operator]
