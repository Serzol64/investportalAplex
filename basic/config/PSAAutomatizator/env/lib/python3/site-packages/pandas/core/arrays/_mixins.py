...
class NDArrayBackedExtensionArray(NDArrayBacked, ExtensionArray):
    ...
    def _concat_same_type(
        ...
        return to_concat[0]._from_backing_data(
    ...
    def fillna(
        ...
        if mask.any():
            if method is not None:
                ...
                func = missing.get_fill_func(method, ndim=self.ndim)
                new_values, _ = func(
                    self._ndarray.T.copy(), limit=limit, mask=mask.T)
    ...
    def _quantile(
        ...
        # TODO: something NDArrayBacked-specific instead of
        # _values_for_factorize[1]?
