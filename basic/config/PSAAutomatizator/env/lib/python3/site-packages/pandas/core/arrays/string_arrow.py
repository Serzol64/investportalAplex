...
class ArrowStringArray(OpsMixin, BaseStringArray, ObjectStringArrayMixin):
    ...
    def value_counts(self, dropna: bool = True) -> Series:
        ...
        # No missing values so we can adhere to the interface and return a
        # numpy array.
    ...
    def _str_contains(self, pat, case=True, flags=0,
                      na=np.nan, regex: bool = True):
        if flags:
    ...
    def _str_fullmatch(self, pat, case: bool = True,
                       flags: int = 0, na: Scalar = None):
        if pa_version_under4p0:
