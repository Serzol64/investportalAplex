...
class TestPeriodMethods:
    ...
    @pytest.mark.parametrize("tzstr",
                             ["Europe/Brussels", "Asia/Tokyo", "US/Pacific"])
...
class TestPeriodProperties:
    ...
    def test_outter_bounds_start_and_end_time(
...
class TestArithmetic:
    ...
    def test_sub_offset(self):
        ...
        for freq in ["H", "2H", "3H"]:
            ...
            assert p - np.timedelta64(3,
                                      "h") == Period("2011-04-01 06:00",
                                                     freq=freq)
