...
class TestSparseArray:
    ...
    def test_getitem_bool_sparse_array(self):
        # GH 23122
        spar_bool = SparseArray([False, True] *
                                5, dtype=np.bool8, fill_value=True)
    ...
    def test_invert_operator(self):
        arr = SparseArray([False, True, False, True],
                          fill_value=False, dtype=np.bool8)
        res = ~arr
        exp = SparseArray(
...
class TestMinMax:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (SparseDtype("datetime64[ns]",
             pd.to_datetime("2018-05-05")), pd.NaT),
        ],
    )
