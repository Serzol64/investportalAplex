...
def test_index_types(setup_path):
    with catch_warnings(record=True):
        ...
        def func(
            l, r): return tm.assert_series_equal(
            l, r, check_index_type=True)
...
def _check_double_roundtrip(self, obj, comparator,
                            path, compression=False, **kwargs):
    options = {}
    if compression:
