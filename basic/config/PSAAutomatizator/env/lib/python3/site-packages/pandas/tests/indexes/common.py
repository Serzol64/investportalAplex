...
class Base:
    ...
    def test_ensure_copied_data(self, index):
        ...
        if isinstance(index, PeriodIndex):
            ...
            pass
        elif isinstance(index, Index) and not isinstance(index.dtype, np.dtype):
    ...
    def test_memory_usage(self, index):
        ...
        if not isinstance(index, (RangeIndex, IntervalIndex)) and not (
            isinstance(index, Index) and not isinstance(index.dtype, np.dtype)
        ):
    ...
    def test_repeat(self, simple_index):
        ...
        new_index_cls = Int64Index if isinstance(
            idx, RangeIndex) else idx._constructor
    ...
    def test_equals(self, index):
        ...
        is_ea_idx = isinstance(
            index, Index) and not isinstance(
