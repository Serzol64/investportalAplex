...
@deprecate_nonkeyword_arguments(
    allowed_args=["io", "sheet_name"], version="2.0")
        ...
        **kwargs,
        ...
        if cls is ExcelWriter:
            ...
            if engine == "xlwt":
                ...
                # Don't warn a 2nd time if user has changed the default engine
                # for xls
...
class ExcelFile:
    ...
    def __init__(
        ...
        if engine == "xlrd" and xlrd_version is not None:
            ...
            # Pass through if ext is None, otherwise check if ext valid for
            # xlrd
