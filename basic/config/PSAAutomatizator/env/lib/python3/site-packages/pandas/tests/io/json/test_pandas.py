...
class TestPandasContainer:
    ...
    def test_roundtrip_simple(
            self, orient, convert_axes, numpy, dtype, float_frame):
    ...
    def test_roundtrip_intframe(
            self, orient, convert_axes, numpy, dtype, int_frame):
    ...
    def test_roundtrip_timestamp(
            self, orient, convert_axes, numpy, datetime_frame):
    ...
    def test_series_roundtrip_object(
            self, orient, numpy, dtype, object_series):
