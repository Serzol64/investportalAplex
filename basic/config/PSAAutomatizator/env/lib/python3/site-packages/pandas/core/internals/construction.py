...
def fill_masked_arrays(data: MaskedRecords,
                       arr_columns: Index) -> list[np.ndarray]:
    """
...
def dict_to_mgr(
    ...
    *,
    ...
    if columns is not None:
        ...
        arrays = [
            arr if not isinstance(
                arr,
                Index) else arr._data for arr in arrays]
        arrays = [
...
def to_arrays(
    ...
    if isinstance(data, ABCDataFrame):
        # see test_from_records_with_index_data,
