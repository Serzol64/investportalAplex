...
class TestSetitemCoercion(CoercionBase):
    ...
    @pytest.mark.parametrize(
        "val,exp_dtype", [(1, object), (1.1, object),
    ...
    def test_setitem_series_timedelta64(self, val, exp_dtype):
        ...
        exp = pd.Series(
            [pd.Timedelta("1 day"), val, pd.Timedelta(
                "3 day"), pd.Timedelta("4 day")]
        )
        self._assert_setitem_series_conversion(obj, val, exp, exp_dtype)
    ...
    def test_setitem_index_float64(self, val, exp_dtype, request):
        ...
        if exp_dtype is IndexError:
            ...
            mark = pytest.mark.xfail(
                reason="TODO_GH12747 The result must be float")
...
class TestInsertIndexCoercion(CoercionBase):
    ...
    def test_insert_index_datetimes(
            self, request, fill_val, exp_dtype, insert_value):
        ...
        if fill_val.tz:
            ...
            # mismatched tz --> cast to object (could reasonably cast to common
            # tz)
...
class TestWhereCoercion(CoercionBase):
    ...
    def test_where_series_datetime64(self, fill_val, exp_dtype):
        ...
        exp = pd.Series(
            [pd.Timestamp("2011-01-01"), fill_val,
