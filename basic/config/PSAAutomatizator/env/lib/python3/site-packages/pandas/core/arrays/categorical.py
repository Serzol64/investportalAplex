...
class Categorical(NDArrayBackedExtensionArray, PandasObject,
    ...
    def rename_categories(self, new_categories, inplace=no_default):
        ...
        if is_dict_like(new_categories):
            cat.categories = [
                new_categories.get(
                    item, item) for item in cat.categories]
    ...
    def reorder_categories(self, new_categories,
                           ordered=None, inplace=no_default):
        """
    ...
    def _get_repr(self, length: bool = True, na_rep="NaN",
    ...
    def _mode(self, dropna: bool = True) -> Categorical:
        ...
        codes = sorted(htable.mode(codes, dropna))
    ...
    def _replace(self, *, to_replace, value, inplace: bool = False):
        ...
        if is_list_like(to_replace):
            ...
            replace_dict = {
                replace_value: value for replace_value in to_replace}
        else:
...
def _get_codes_for_values(values, categories: Index) -> np.ndarray:
    ...
    if isinstance(categories.dtype,
                  ExtensionDtype) and is_object_dtype(values):
