...
def test_resample_single_group():
    ...
    expected = Series([0.75], index=DatetimeIndex(
        [Timestamp("20070915")], freq="D"))
...
def test_resample_dst_anchor():
    ...
    tm.assert_frame_equal(
        ...
        DataFrame(
            [5],
            index=DatetimeIndex([datetime(2012, 11, 1)],
                                tz="US/Eastern", freq="MS"),
        ),
    )
