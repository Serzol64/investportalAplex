...
class PyxlsbReader(BaseExcelReader):
    ...
    def get_sheet_by_index(self, index: int):
        ...
        # There's a fix for this in the source, but the pypi package doesn't
        # have it
        return self.book.get_sheet(index + 1)

    def _convert_cell(self, cell, convert_float: bool) -> Scalar:
        # TODO: there is no way to distinguish between floats and datetimes in pyxlsb
        # This means that there is no way to read datetime types from an xlsb
        # file yet
        if cell.v is None:
    ...
    def get_sheet_data(self, sheet, convert_float: bool) -> list[list[Scalar]]:
        ...
        for row in sheet.rows(sparse=True):
            ...
            converted_row = [
                self._convert_cell(
                    cell, convert_float) for cell in row]
