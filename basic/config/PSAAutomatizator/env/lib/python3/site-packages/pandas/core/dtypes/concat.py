...
def concat_compat(to_concat, axis: int = 0, ea_compat_axis: bool = False):
    ...
    if any_ea:
        ...
        if not single_dtype:
            ...
            to_concat = [
                cast_to_common_type(
                    arr, target_dtype) for arr in to_concat]
...
def union_categoricals(
    ...
    return Categorical(new_codes, categories=categories,
...
def _concat_datetime(to_concat, axis=0):
    ...
    if not single_dtype:
        ...
        return _concatenate_2d([x.astype(object)
                               for x in to_concat], axis=axis)
