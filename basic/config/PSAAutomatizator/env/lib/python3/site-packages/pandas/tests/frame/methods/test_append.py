...
class TestDataFrameAppend:
    ...
    def test_append_multiindex(
            self, multiindex_dataframe_random_data, frame_or_series):
    ...
    def test_append_timestamps_aware_or_naive(
            self, tz_naive_fixture, timestamp):
        # GH 30238
        tz = tz_naive_fixture
