...
class TestIndex(Base):
    ...
    @pytest.mark.parametrize("index",
                             ["string", "int", "float"], indirect=True)
    ...
    def test_map_dictlike(self, index, mapper):
        ...
        elif isinstance(index, Index) and index.dtype != object:
    ...
    def test_isin_nan_common_object(
            self, request, nulls_fixture, nulls_fixture2):
...
def test_deprecated_fastpath():
    ...
    with pytest.raises(TypeError, match=msg):
        Int64Index(np.array([1, 2, 3], dtype="int64"),
                   name="test", fastpath=True)
