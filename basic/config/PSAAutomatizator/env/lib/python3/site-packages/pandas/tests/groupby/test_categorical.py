...
def test_basic():  # TODO: split this test
    ...
    with tm.assert_produces_warning(
        ...
        # stacklevel is thrown off (i think) bc the stack goes through numpy C
        # code
...
def test_preserve_categories():
    ...
    nosort_index = CategoricalIndex(
        list("bac"), list("bac"), ordered=False, name="A")
    tm.assert_index_equal(
...
def test_preserve_categorical_dtype():
    ...
    for col in ["C1", "C2"]:
        ...
        result2 = df.groupby(
            by=col,
            as_index=True,
            observed=False).mean().reset_index()
...
def test_seriesgroupby_observed_true(df_cat, operation):
    # GH 24880
    lev_a = Index(["foo", "foo", "bar", "bar"],
                  dtype=df_cat["A"].dtype, name="A")
    lev_b = Index(["one", "two", "one", "three"],
