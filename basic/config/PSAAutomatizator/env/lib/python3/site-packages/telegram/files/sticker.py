...
class Sticker(TelegramObject):
    ...
    def get_file(
        ...
        """
        return self.bot.get_file(file_id=self.file_id,
...
class MaskPosition(TelegramObject):
    ...
    def __init__(self, point: str, x_shift: float,
                 y_shift: float, scale: float, **_kwargs: Any):
        self.point = point
