...
class Chat(TelegramObject):
    ...
    def __init__(
        ...
        **_kwargs: Any,
        ...
        self.all_members_are_administrators = _kwargs.get(
            'all_members_are_administrators')
        self.photo = photo
        self.bio = bio
    ...
    def leave(self, timeout: ODVInput[float] = DEFAULT_NONE,
    ...
    def send_poll(
        ...
        # We use constant.POLL_REGULAR instead of Poll.REGULAR here to avoid
        # circular imports
