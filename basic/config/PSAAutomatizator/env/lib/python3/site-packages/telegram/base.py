...
class TelegramObject:
    ...
    # We add __dict__ here for backward compatibility & also to avoid
    # repetition for subclasses.
    __slots__ = ('__dict__',)
    ...
    @classmethod
    def de_json(cls: Type[TO], data: Optional[JSONDict],
                bot: 'Bot') -> Optional[TO]:
    ...
    @classmethod
    def de_list(cls: Type[TO], data: Optional[List[JSONDict]],
    ...
    def to_dict(self) -> JSONDict:
        ...
        attrs = {
            attr for cls in self.__class__.__mro__[
                :-2] for attr in cls.__slots__}
        for key in attrs:
