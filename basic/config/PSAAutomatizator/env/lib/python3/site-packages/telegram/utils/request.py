...
# type: ignore  # pylint: disable=W0212
    ...
    def post(self, url: str, data: JSONDict,
            ...
            if isinstance(val, InputFile):
                ...
                if isinstance(val, list):
                    ...
                    for med in val:
                        ...
                        if isinstance(med.media, InputFile):
                            ...
                            # if the file has a thumb, we also need to attach
                            # it to the data
                ...
                # Single media
                    ...
                    if isinstance(val.media, InputFile):
                        ...
                        # if the file has a thumb, we also need to attach it to
                        # the data
                        if "thumb" in media_dict:
        ...
        if files:
            result = self._request_wrapper(
                'POST', url, fields=data, **urlopen_kwargs)
        else:
            result = self._request_wrapper(
                'POST',
                url,
