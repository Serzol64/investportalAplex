...
class ExtBot(telegram.bot.Bot):
    ...
    def __init__(
        ...
        # We don't pass this to super().__init__ to avoid the deprecation
        # warning
    ...
    def _replace_keyboard(
        ...
        if isinstance(reply_markup,
                      InlineKeyboardMarkup) and self.arbitrary_callback_data:
