...
class DelayQueue(threading.Thread):
    ...
    def __call__(self, func: Callable, *args: object,
                 **kwargs: object) -> None:
        ...
        if not self.is_alive() or self.__exit_req:
            raise DelayQueueError(
                'Could not process callback in stopped thread')
...
class MessageQueue:
    ...
    def __call__(self, promise: Callable,
                 is_group_msg: bool = False) -> Callable:
        """
...
def queuedmessage(method: Callable) -> Callable:
    ...
    def wrapped(self: 'Bot', *args: object, **kwargs: object) -> object:
        ...
        queued = kwargs.pop(
            ...
            'queued', self._is_messages_queued_default
        )
