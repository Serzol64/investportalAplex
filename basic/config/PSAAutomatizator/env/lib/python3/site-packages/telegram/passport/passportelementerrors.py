...
class PassportElementError(TelegramObject):
    ...
    # All subclasses of this class won't have _id_attrs in slots since it's
    # added here.
...
class PassportElementErrorDataField(PassportElementError):
    ...
    def __init__(self, type: str, field_name: str,
                 data_hash: str, message: str, **_kwargs: Any):
        # Required
...
class PassportElementErrorFile(PassportElementError):
    ...
    def __init__(self, type: str, file_hash: str,
                 message: str, **_kwargs: Any):
        # Required
