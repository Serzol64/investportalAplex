    ...
    def process_callback_query(self, callback_query: CallbackQuery) -> None:
        ...
        with self.__lock:
            ...
            if callback_query.data:
                ...
                # Map the callback queries ID to the keyboards UUID for later
                # use
                if not mapped and not isinstance(
                        button_data, InvalidCallbackData):
                    # type: ignore
    ...
    def drop_data(self, callback_query: CallbackQuery) -> None:
        ...
        with self.__lock:
            try:
                ...
                raise KeyError(
                    'CallbackQuery was not found in cache.') from exc
