...
try:
    ...
    MGF1, OAEP, Cipher, AES, CBC = (
        None, None, None, None, None)  # type: ignore[misc]
...
class Credentials(TelegramObject):
    ...
    def __init__(self, secure_data: 'SecureData', nonce: str,
                 bot: 'Bot' = None, **_kwargs: Any):
        # Required
...
class _CredentialsBase(TelegramObject):
    ...
    def __init__(self, hash: str, secret: str,
                 bot: 'Bot' = None, **_kwargs: Any):
        self.hash = hash
        self.secret = secret
