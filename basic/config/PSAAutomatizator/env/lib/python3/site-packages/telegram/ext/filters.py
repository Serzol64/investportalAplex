...
class BaseFilter(ABC):
    ...
    if py_ver < (3, 7):
        ...
        __slots__ = ('_name', '_data_filter', '__dict__')
    ...
    def __setattr__(self, key: str, value: object) -> None:
        ...
        # simple way of checking the module name where the class is defined
        # from.
        if (
    ...
    def __repr__(self) -> str:
        # We do this here instead of in a __init__ so filter don't have to call
        # __init__ or super()
...
class MergedFilter(UpdateFilter):
    ...
    def _merge(base_output: Union[bool, Dict],
               comp_output: Union[bool, Dict]) -> DataDict:
...
officedocument.wordprocessingml.document")``.
    ...
    class _ChatUserBaseFilter(MessageFilter, ABC):
        ...
        @abstractmethod
        def get_chat_or_user(
                self, message: Message) -> Union[Chat, User, None]:
            ...
    ...
    class forwarded_from(_ChatUserBaseFilter):
        ...
        def get_chat_or_user(
                self, message: Message) -> Union[User, Chat, None]:
