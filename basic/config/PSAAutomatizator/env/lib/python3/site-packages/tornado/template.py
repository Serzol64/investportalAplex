...
class Template(object):
    ...
    def __init__(
        ...
        if compress_whitespace is not _UNSET:
            # Convert deprecated compress_whitespace (bool) to whitespace
            # (str).
...
class BaseLoader(object):
    ...
    def resolve_path(self, name: str,
                     parent_path: Optional[str] = None) -> str:
...
class _NamedBlock(_Node):
    def __init__(self, name: str, body: _Node,
                 template: Template, line: int) -> None:
        self.name = name
        self.body = body
        self.template = template
        self.line = line
...
class _IncludeBlock(_Node):
    def __init__(self, name: str, reader: "_TemplateReader",
                 line: int) -> None:
        self.name = name
