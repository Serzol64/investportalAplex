...
class IOLoop(Configurable):
    ...
    def configure(
        ...
        if asyncio is not None:
            ...
            if isinstance(impl, type) and not issubclass(
                    impl, BaseAsyncIOLoop):
                raise RuntimeError(
        ...
        try:
            ...
            if instance:
                ...
                current = AsyncIOMainLoop(
                    make_current=True)  # type: Optional[IOLoop]
            else:
                current = None
        return current
    ...
    def add_callback(self, callback: Callable, *args: Any,
                     **kwargs: Any) -> None:
    ...
    def spawn_callback(self, callback: Callable, *args: Any,
                       **kwargs: Any) -> None:
