...
class ParseErrorDetailTest(unittest.TestCase):
    def test_details(self):
        ...
        self.assertEqual(
            "Missing end expression }} at foo.html:3", str(
                cm.exception))
...
raw: {% raw name %}""",
    ...
    def test_extended_block(self):
        ...
        self.assertEqual(
            render("escaped_extends_unescaped.html"),
            b"base: <script>")
        self.assertEqual(
    ...
    def test_custom_escape(self):
        ...
        def render(template, name):
            return loader.load(template).generate(
                py_escape=py_escape, name=name)
...
%}"""
    ...
    def test_whitespace_by_filename(self):
        ...
        self.assertEqual(
            loader.load("include.html").generate(),
            b" \t    zxcv\n\n\n")
        self.assertEqual(
            loader.load("include.txt").generate(),
            b"\t\t\nasdf     ")
