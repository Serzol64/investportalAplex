...
class HTTP1Connection(httputil.HTTPConnection):
    ...
    async def _read_message(self, delegate: httputil.HTTPMessageDelegate) -> bool:
        ...
        try:
            ...
            if self.is_client:
                ...
                # TODO: this will need to change to support client-side
                # keepalive
                self._disconnect_on_finish = False
            else:
            ...
            if self.is_client:
                ...
                if headers.get(
                        "Expect") == "100-continue" and not self._write_finished:
    ...
    def _read_body(
        ...
        if code == 204:
            ...
            if "Transfer-Encoding" in headers or content_length not in (
                    None, 0):
                raise httputil.HTTPInputError(
