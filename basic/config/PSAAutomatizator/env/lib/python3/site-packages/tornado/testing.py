...
class _TestMethodWrapper(object):
    ...
    def __call__(self, *args: Any, **kwargs: Any) -> None:
        ...
        if isinstance(result, Generator) or inspect.iscoroutine(result):
            ...
            raise ValueError(
                "Return value from test method ignored: %r" %
                result)
...
def gen_test(func: Callable[..., Union[Generator,
...
def gen_test(  # noqa: F811
    ...
    def wrap(f: Callable[..., Union[Generator, "Coroutine"]]
             ) -> Callable[..., None]:
        ...
        def post_coroutine(self, *args, **kwargs):
            ...
            try:
                ...
                # a native coroutine, so we can rely on the cr_running
                # attribute.
                ...
                # so re-raise the original exception which is better than
                # nothing.
                raise
