...
class HTTPHeaders(collections.abc.MutableMapping):
    ...
    def __init__(self, *args: typing.Any, **kwargs: str) -> None:  # noqa: F811
        ...
        if len(args) == 1 and len(
                kwargs) == 0 and isinstance(args[0], HTTPHeaders):
            # Copy constructor
    ...
    def get_ssl_certificate(
        ...
        try:
            if self.connection is None:
                return None
            # TODO: add a method to HTTPConnection for this so it can work with
            # HTTP/2
...
def _get_content_range(
        start: Optional[int], end: Optional[int], total: int) -> str:
...
def parse_response_start_line(line: str) -> ResponseStartLine:
    ...
    return ResponseStartLine(match.group(
        1), int(match.group(2)), match.group(3))
