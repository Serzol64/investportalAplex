...
class RequestHandler(object):
    ...
    def get_body_argument(
        ...
        return self._get_argument(
            name, default, self.request.body_arguments, strip)
    ...
    def get_query_argument(
        ...
        """
        return self._get_argument(
            name, default, self.request.query_arguments, strip)
    ...
    def clear_all_cookies(self, path: str = "/",
    ...
    def create_template_loader(
            self, template_path: str) -> template.BaseLoader:
    ...
    def finish(
            self, chunk: Optional[Union[str, bytes, dict]] = None) -> "Future[None]":
    ...
    def get_browser_locale(
            self, default: str = "en_US") -> tornado.locale.Locale:
    ...
    def _decode_xsrf_token(
        ...
        try:
            ...
            gen_log.debug(
                "Uncaught exception in _decode_xsrf_token",
                exc_info=True)
    ...
    def require_setting(self, name: str,
                        feature: str = "this feature") -> None:
    ...
    def _ui_module(self, name: str,
                   module: Type["UIModule"]) -> Callable[..., str]:
...
class Application(ReversibleRouter):
    ...
    def add_handlers(self, host_pattern: str,
                     host_handlers: _RuleList) -> None:
...
class StaticFileHandler(RequestHandler):
    ...
    **Subclassing notes**
    ...
    def validate_absolute_path(
            self, root: str, absolute_path: str) -> Optional[str]:
        ...
        if not (absolute_path + os.path.sep).startswith(root):
            raise HTTPError(
                403,
                "%s is not in root static directory",
                self.path)
...
def decode_signed_value(
    ...
    if version == 1:
        assert not isinstance(secret, dict)
        return _decode_signed_value_v1(
            secret, name, value, max_age_days, clock)
    elif version == 2:
        return _decode_signed_value_v2(
            secret, name, value, max_age_days, clock)
    else:
        return None
...
def _decode_signed_value_v1(
    ...
    if timestamp > clock() + 31 * 86400:
        ...
        gen_log.warning(
            "Cookie timestamp in future; possible tampering %r",
            value)
        return None
