...
class AsyncHTTPClient(Configurable):
    ...
    def __new__(cls, force_instance: bool = False,
                **kwargs: Any) -> "AsyncHTTPClient":
...
class HTTPRequest(object):
    ...
    @headers.setter
    def headers(self, value: Union[Dict[str, str],
...
class HTTPResponse(object):
    ...
    * ``time_info``: dictionary of diagnostic timing information from the
    ...
    # I'm not sure why these don't get type-inferred from the references in
    # __init__.
