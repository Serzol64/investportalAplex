...
class CurlAsyncHTTPClient(AsyncHTTPClient):
    ...
    def _handle_socket(self, event: int, fd: int,
                       multi: Any, data: bytes) -> None:
    ...
    def _process_queue(self) -> None:
        while True:
            ...
            while self._free_list and self._requests:
                ...
                # TODO: Don't smuggle extra data on an attribute of the Curl
                # object.
    ...
    def _curl_header_callback(
        ...
        # whitespace at the start should be preserved to allow multi-line
        # headers
