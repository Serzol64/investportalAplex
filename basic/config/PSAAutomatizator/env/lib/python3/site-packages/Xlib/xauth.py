...
class Xauthority:
    def __init__(self, filename=None):
        ...
        try:
            ...
            print(
                "Xlib.xauth: warning, failed to parse part of xauthority file (%s), aborting all further parsing" %
                filename)

        if len(self.entries) == 0:
            print("Xlib.xauth: warning, no xauthority details available")
            # raise an error?  this should get partially caught by the
            # XNoAuthError in get_best_auth..
