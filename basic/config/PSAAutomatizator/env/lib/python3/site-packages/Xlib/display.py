...
class Display:
        ...
        if object == 'display':
            if hasattr(self, name):
                raise AssertionError(
                    'attempting to replace display method: %s' %
                    name)
    ...
    def change_active_pointer_grab(
            self, event_mask, cursor, time, onerror=None):
    ...
    def open_font(self, name):
        ...
        if ec.get_error():
            ...
            cls = self.display.get_resource_class(
                'font', Xlib.xobject.fontable.Font)
    ...
    def set_screen_saver(self, timeout, interval,
