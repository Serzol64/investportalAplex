...
class Drawable(resource.Resource):
    ...
    def copy_area(self, gc, src_drawable, src_x, src_y,
...
class Window(Drawable):
    ...
    def convert_selection(self, selection, target,
                          property, time, onerror=None):
    ...
    def clear_area(self, x=0, y=0, width=0, height=0,
    ...
    def get_wm_protocols(self):
        d = self.get_full_property(
            self.display.get_atom('WM_PROTOCOLS'), Xatom.ATOM)
