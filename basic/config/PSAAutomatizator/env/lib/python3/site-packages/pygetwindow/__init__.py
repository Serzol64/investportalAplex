...
# get/click menu (win32: GetMenuItemCount, GetMenuItemInfo, GetMenuItemID,
# GetMenu, GetMenuItemRect)
...
if sys.platform == "darwin":
    # raise NotImplementedError('PyGetWindow currently does not support macOS.
    # If you have Appkit/Cocoa knowledge, please contribute!
    # https://github.com/asweigart/pygetwindow') # TODO - implement mac
