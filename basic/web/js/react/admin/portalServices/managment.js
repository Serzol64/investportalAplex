	...
	componentDidMount(){
		if(this.state.currentType === 'true'){
			...
			$('#service-editor > button#send').click(function(){
				...
				if($('#service-editor > *[data-block=\'automatization\'] ul li input').eq(1).val() !== ''){ queryReadyData.proc.control = $('#service-editor > *[data-block=\'automatization\'] ul li input').eq(1).val(); }
