	...
	<body>
		...
		<header class="header">
				...
				<div id="header_bottom_adaptive">
					<?php
						if(isset($_COOKIE['portalId'])){ $mobileAuth = '<li data-profile="passport"><i class="fas fa-briefcase" style="color: #0079bf;"></i></li>'; }
						else{ $mobileAuth = '<li><i class="fas fa-user-check" style="color: #0079bf;"></i></li>'; }
					?>
					<header>
        ...
        <section class="module-page" data-screen="SignIn">
            ...
            <main>
              ...
              <div class="module-form">
                ...
                <div id="form-submit" style="display:none;"><fb:login-button auto-logout-link="false" size="medium" button-type="login_with" use-continue-as="true" scope="public_profile, email" onlogin="new FacebookDataAccess('SignIn').proccess();"></fb:login-button></div>
              ...
              <ul id="reg-content">
                ...
                <li data-signstep="1" style="display: none;">
                  ...
                  <div><label for="user-email">E-Mail</label>
                    ...
                    <input type="tel" name="phone" placeholder="Enter the phone number in this format: 79012345678"/></div>
                  </form>
                </li>
        ...
        <section class="module-page" data-screen="Forgot">
            ...
            <main>
              ...
              <ul id="reg-content">
                <li data-signstep="0">
                  <form action="#" method="post">
                  <div><label for="investportal-id">Phone number for access restore</label>
