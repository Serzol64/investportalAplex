...
<main class="main">
	<section id="promo" class="section">
		<header>
			<div class="promo-header">
			   ...
			   <?php if(!isset($_COOKIE['portalId'])) { ?><button class="add-but">Add Object</button><?php } ?>
			   <div class="links"></div>
			</div>
	...
	<section id="investsearch" class="section">
			<header>
                ...
                <?php if(!isset($_COOKIE['portalId'])) { ?><button class="add-but" style="border: solid 2px gray;">Add Request</button><?php } ?>
                <a href=""></a>
            </header>
            <main class="swiper-container">
